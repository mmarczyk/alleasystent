...
archive/invoice-monitoring branch. Its old "allegro:invoice_monitor:enabled:*"
keys are simply never read again and expire with the Redis instance.
"""
